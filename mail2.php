 ...
 if(isset($_POST['email']))
{
	...
	$drop=$_POST['drop'];
		...
		$to=$email;    
        $subject = "Your Booking Successfully Received by Malik Transport Pvt. Ltd.";
...
<img src='https://maliktransport.co.in/images/logo-small.png' width='39%' class='CToWUd'></a></td>
   ...
   <tr>
    <td bgcolor='#fff' align='left'><a style='text-decoration:none;color:#545454;padding:0px 0px;font:normal 22px calibri;color:#000' href='#m_5214483983294932554_m_-2506295658882639727_'>Hi $email,</a></td>
   </tr>
   <tr><td bgcolor='#fff' height='10'></td></tr>
    <tr>
   ...
   <tr><td bgcolor='#fff' height='10'></td></tr>
    ...
    Thank you for your Booking on Malik Transport Pvt. Ltd. We appreciate you
for taking the time to our Website.
	 ...
	 <b>Pickup From :</b> $pickup <br>
	 <b>Pickup Date :</b> $pickdate <br>
	 <b>Pickup Time :</b> $picktime <br>
	 <b>Drop:</b> $drop <br>
